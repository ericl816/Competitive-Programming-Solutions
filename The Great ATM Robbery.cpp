...
Analysis:
In this problem, once the bandit enters an SCC, he can pick up the money in all ATMs in the SCC.
Assign to each SCC a weight equal to the sum of amounts in its ATMs.

A SCC is "final" if it contains a pub.

Now, the problem is to find a path in the SCC DAG of maximum weight such that it starts in the SCC
containing the start vertex and ends in one of the final SCC.
This can be easily computed once we have built the SCC DAG.
*/
