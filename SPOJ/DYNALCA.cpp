...
A forest of rooted trees initially consists of N (1 â¤ N â¤ 100,000) single-vertex trees. The vertices are numbered from 1 to N.

You must process the following queries, where (1 â¤ A, B â¤ N):
